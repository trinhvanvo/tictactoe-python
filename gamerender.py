...
class GameRender:
    ...
    def draw_board(self, board_state, info_text, info_text_color, last_move, last_move_color):
        ...
        self.draw_button(render_settings.NEW_GAME_BUTTON_POS, render_settings.BUTTON_WIDTH, render_settings.BUTTON_HEIGHT, "RESET")
      
        #draw HOME button
        self.draw_button(render_settings.HOME_BUTTON_POS, render_settings.BUTTON_WIDTH, render_settings.BUTTON_HEIGHT, "HOME")
